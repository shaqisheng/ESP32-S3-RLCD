...
private:
    ...
    // Serializes input feed with AFE start/stop/destruction. Event bits alone
    // are insufficient because AudioInputTask may hold a stale bit snapshot.
    std::mutex input_pipeline_mutex_;
