...
public:
    ...
    // Runs after the network is connected and before OTA/device activation.
    // Boards may override this to prepare data that must be available first.
    virtual void PrepareForActivation() {}
