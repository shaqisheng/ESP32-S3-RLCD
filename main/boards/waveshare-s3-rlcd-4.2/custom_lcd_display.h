...
private:
    ...
    lv_obj_t *date_detail_label_ = nullptr;
    lv_obj_t *weather_icon_image_ = nullptr;
    lv_obj_t *weather_detail_label_ = nullptr;
    lv_obj_t *calendar_year_label_ = nullptr;
    lv_obj_t *calendar_month_label_ = nullptr;
    lv_obj_t *calendar_subtitle_label_ = nullptr;
    std::array<lv_obj_t*, 7> calendar_column_labels_{};
    lv_obj_t *calendar_today_highlight_ = nullptr;
    struct CalendarDayCell {
        lv_obj_t* root = nullptr;
        lv_obj_t* day = nullptr;
        lv_obj_t* detail = nullptr;
    };
    std::array<CalendarDayCell, 42> calendar_day_cells_{};
    lv_obj_t *forecast_city_label_ = nullptr;
    lv_obj_t *forecast_updated_label_ = nullptr;
    lv_obj_t *forecast_now_icon_image_ = nullptr;
    lv_obj_t *forecast_now_label_ = nullptr;
    lv_obj_t *forecast_detail_label_ = nullptr;
    std::array<lv_obj_t*, 7> forecast_column_labels_{};
    std::array<lv_obj_t*, 7> forecast_icon_images_{};
    ...
    // ===== AI 额度页 UI 组件 =====
    lv_obj_t *quota_header_label_ = nullptr;
    lv_obj_t *quota_admin_label_ = nullptr;
    lv_obj_t *quota_refresh_label_ = nullptr;
    lv_obj_t *quota_empty_label_ = nullptr;
    std::array<lv_obj_t*, 4> quota_cards_{};
    ...
    uint32_t quota_page_changed_ms_ = 0;
...
public:
    ...
    bool IsPomodoroMode() const { return false; }
