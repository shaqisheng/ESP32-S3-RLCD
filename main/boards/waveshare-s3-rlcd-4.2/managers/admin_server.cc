...
<section id="dashboard" class="hidden"><div class="toolbar" style="justify-content:flex-end"><div><button id="refreshBtn">立即刷新</button> <button id="logoutBtn">退出</button></div></div>
...
<section class="panel"><div class="toolbar"><h2 style="border:0;margin:0">待办事项</h2><button onclick="openTodoModal()">＋ 新增待办</button></div><div id="todos"></div></section>
</div>
